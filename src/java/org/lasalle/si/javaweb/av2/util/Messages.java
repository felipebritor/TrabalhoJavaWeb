...
package org.lasalle.si.javaweb.av2.util;
...
public class Messages {
    ...
    public static FacesMessage getMessage(String bundleName, String resourceId, Object params[]){
        ...
        System.out.println(appBundle +" " + bundleName +" " + resourceId +" " + locale +" " + loader +" " + params);
        ...
        if(bundle1 != null){
            ...
            if (bundle != null) {
                try{
                    ...
                    System.out.println("Erro recurso nao encontrado");
                }
            }
        }
